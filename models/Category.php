...
class Category extends Model
{
     ...
     */
    public $table = 'jetminds_job_categories';
    ...
    public $translatable = [
        'name',
        ['slug', 'index' => true],
        'code' => 'unique:jetminds_job_categories',
        'description'
    ];

    public $rules = [
        'name' => 'required',
        'slug' => ['required', 'regex:/^[a-z0-9\/\:_\-\*\[\]\+\?\|]*$/i', 'unique:jetminds_job_categories'],
    ];
    ...
    public function getParentOptions()
    {
        $options = [
            ...
            null => trans('jetminds.job::lang.models.category.fields.parent.empty'),
        ];
    ...
    public static function getMenuTypeInfo($type)
    {
        ...
        if ($result) {
            ...
            foreach ($pages as $page) {
                if (!$page->hasComponent('jobVacancies')) {
                    continue;
                }
                 ...
                 */
                $properties = $page->getComponentProperties('jobVacancies');
    ...
    public static function resolveMenuItem($item, $url, $theme)
    {
        ...
        elseif ($item->type == 'all-job-categories') {
            $result = [
                'items' => []
            ];
